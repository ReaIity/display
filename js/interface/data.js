...
function showDay() {
	...
	date = new Date(),
	day = date.getDay(),
	dayOfTheWeek = document.createElement('div'),
	data = document.getElementById('data');


	dayOfTheWeek.classList.add('dayOfTheWeek');
	dayOfTheWeek.setAttribute('id', 'weekday');
	

	
	data.appendChild(dayOfTheWeek);
	showInside();
...
function showInside() {
	var dat = new Date(),
	dayOfTheWeek = document.getElementById('weekday'),
	month = dat.getMonth(),
	day = dat.getDate(),
	year = dat.getFullYear(),
	weekd = document.createElement('div'),
	d = dat.getDay();
	var color_step = 0;
	...
	weekd.innerHTML = days[d];
	weekd.classList.add('weekd');
	dayOfTheWeek.innerHTML = month + 1 + '.' + day + '.' + year ;
	...
	dayOfTheWeek.appendChild(weekd);
}

function createHourMinuteSecond() {
